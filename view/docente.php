        ...
        <section class="sidebar">
           ...
           <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active" rel="./view/notas/agregarNotas.php"    id="_li1" style="cursor:pointer"><a><i class="fa fa-circle-o li__"></i><span>Notas</span></a></li>   
                    </ul>
              </li>
            ...
            <ul class="sidebar-menu" id="sidebar-menu">
              <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li rel=""    id="_li2" style="cursor:pointer"><a><i class="fa fa-circle-o li__"></i><span>Notas</span></a></li>   
                    </ul>
              </li>
