            ...
            <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active" rel="./view/instituciones/agregarInstituciones.php"    id="_li1" style="cursor:pointer"><a><i class="fa fa-circle-o li__"></i><span>Agregar</span></a></li>
                        <li rel="./view/instituciones/buscaInstituciones.php"     id="_li2" style="cursor:pointer"><a><i class="fa fa-circle-o li__"></i><span>Buscar</span></a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a >
                        <i class="glyphicon glyphicon-user"></i>
                        <span>Admin.Instituciones</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li  rel="./view/usuarios/agregarUsuario.php"    id="_li2" style="cursor:pointer"><a><i class="fa fa-circle-o li__"></i><span>Agregar</span></a></li>
                        <li rel="./view/usuarios/buscarUsuario.php"     id="_li3" style="cursor:pointer"><a><i class="fa fa-circle-o li__"></i><span>Buscar</span></a></li>
                    </ul>
                </li>
