<html>
    ...
    <body>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6  ">
                               ...
                               <form role="form" action="" class="form-horizontal" >
                                    <fieldset>
                                        <div class="row">          
                                          <div class="col-xs-12">
                                            <legend>Datos Finca </legend>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                            <label id="lt_nombre" class="control-label col-xs-3">Nombre</label>
                                            <div class="col-xs-9"><input id="t_nombre" type="text" class="form-control" ></div>
                                       </div>
                                    </fieldset>
                                </form>
                            </div>
        ...
        <script src="js/crearFinca.js" type="text/javascript"></script>
    </body>
</html>
